...
class MIXIM_API Decider80211Battery : public Decider80211
{
    ...
    public:
         ...
         */
        Decider80211Battery(DeciderToPhyInterface* phy, double threshold, double sensitivity, int channel,
                double decodingCurrentDelta, int myIndex = -1, bool debug = false) :
                Decider80211(phy, threshold, sensitivity, channel, myIndex, debug), decodingCurrentDelta(
