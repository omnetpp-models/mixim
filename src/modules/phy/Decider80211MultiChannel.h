...
class MIXIM_API Decider80211MultiChannel : public Decider80211Battery
{
    ...
    public:
         ...
         */
        Decider80211MultiChannel(DeciderToPhyInterface* phy, double threshold, double sensitivity,
                double decodingCurrentDelta, int currentChannel, int myIndex = -1, bool debug = false);
