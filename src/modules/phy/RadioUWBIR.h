...
class MIXIM_API RadioUWBIR : public MiximRadio
{
    ...
    public:
        ...
        static RadioUWBIR* createNewUWBIRRadio(bool recordStats, int initialState, Argument::mapped_type_cref minAtt =
                Argument::MappedOne, Argument::mapped_type_cref maxAtt = Argument::MappedZero)
        {
            return new RadioUWBIR(RadioUWBIR::UWBIR_NUM_RADIO_STATES, recordStats, initialState, minAtt, maxAtt);
        }
