...
class MIXIM_API ProbBcastNetwControlInfo : public NetwControlInfo
{
    ...
    public:
        ...
        ProbBcastNetwControlInfo(const LAddress::L3Type& addr = LAddress::L3NULL, simtime_t_cref vttl = 0,
                double vcriticality = 0.0, unsigned int vid = 0) :
                NetwControlInfo(addr), ttl(vttl), criticality(vcriticality), id(vid)
        {
        }
        ;
