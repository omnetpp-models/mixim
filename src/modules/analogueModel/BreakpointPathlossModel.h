...
//	SimplePathlossModel farRangeModel;
    ...
    public:
        ...
        BreakpointPathlossModel(double L01, double L02, double alpha1, double alpha2, double breakpointDistance,
                ...
                AnalogueModel(), PL01(L01), PL02(L02), PL01_real(0), PL02_real(0), alpha1(alpha1), alpha2(alpha2), breakpointDistance(
                        breakpointDistance), carrierFrequency(carrierFrequency), useTorus(useTorus), playgroundSize(
                        playgroundSize), debug(debug), pathlosses()
        {
