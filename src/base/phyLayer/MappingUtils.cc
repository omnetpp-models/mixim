...
Mapping* MappingUtils::createMapping(Mapping::argument_value_cref_t outOfRangeVal, const DimensionSet& domain,
...
Mapping::argument_value_t MappingUtils::findMax(const ConstMapping& m,
...
Mapping::argument_value_t MappingUtils::findMax(const ConstMapping& m, const Argument& pRangeFrom,
        const Argument& pRangeTo, Argument::mapped_type_cref cRetNotFound /*= cMaxNotFound*/)
{
...
Mapping::argument_value_t MappingUtils::findMin(const ConstMapping& m,
...
Mapping::argument_value_t MappingUtils::findMin(const ConstMapping& m, const Argument& pRangeFrom,
        const Argument& pRangeTo, Argument::mapped_type_cref cRetNotFound /*= cMinNotFound*/)
{
    const DimensionSet& rDimSet = m.getDimensionSet();
    //the passed interval should define a value for every dimension
    //of the mapping.
...
void MappingUtils::addDiscontinuity(Mapping* m, const Argument& pos, Mapping::argument_value_cref_t value,
...
LinearIntplMappingIterator::LinearIntplMappingIterator(ConstMappingIterator* leftIt, ConstMappingIterator* rightIt,
