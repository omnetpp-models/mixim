    ...
    public:
        ...
        MultipliedMapping* getReceivingPower()
        {
            if (!rcvPower)
            {
                ...
                rcvPower = new MultipliedMapping(tmp, attenuations.begin(), attenuations.end(), false,
                        Argument::MappedZero);
            }
        ...
        {
            return receiverModuleID < 0 ? NULL : simulation.getModule(receiverModuleID);
        }
        ...
        {
            return senderModuleID < 0 ? NULL : simulation.getModule(senderModuleID);
        }
