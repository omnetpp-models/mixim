...
class MIXIM_API RadioStateAnalogueModel : public AnalogueModel
{
    ...
    public:
         ...
         */
        RadioStateAnalogueModel(Argument::mapped_type_cref initValue, bool currentlyTracking = false,
                simtime_t_cref initTime = SIMTIME_ZERO) :
                AnalogueModel(), currentlyTracking(currentlyTracking), radioStateAttenuation()
        {
...
class MIXIM_API RSAMConstMappingIterator : public ConstMappingIterator
{
    ...
    public:
        ...
        RSAMConstMappingIterator(const RadioStateAnalogueModel* rsam, simtime_t_cref signalStart,
...
class MIXIM_API RSAMMapping : public ConstMapping
{
    ...
    public:
        ...
        RSAMMapping(const RSAMMapping& o) :
                ConstMapping(o), rsam(o.rsam), signalStart(o.signalStart), signalEnd(o.signalEnd)
        {
        }
    ...
    public:
         ...
         *
         */
        RSAMMapping(const RadioStateAnalogueModel* rsam, simtime_t_cref signalStart, simtime_t_cref signalEnd) :
                ConstMapping(), rsam(rsam), signalStart(signalStart), signalEnd(signalEnd)
        {
            assert(rsam);
