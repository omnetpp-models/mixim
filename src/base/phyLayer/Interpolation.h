...
class Linear : public InterpolatorBase<_ContainerType>
{
    ...
    protected:
        ...
        static mapped_type linearInterpolation(key_cref_type t, key_cref_type t0, key_cref_type t1, mapped_cref_type v0,
                mapped_cref_type v1)
        {
...
class ConstInterpolateableIterator
{
    ...
    public:
         ...
         * as boundaries.
         */
        ConstInterpolateableIterator(const used_iterator& first, const used_iterator& last,
