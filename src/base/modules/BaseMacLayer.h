...
class MIXIM_API BaseMacLayer : public BaseLayer
{
    ...
    public:
        ...
        BaseMacLayer() :
                BaseLayer(), phy(NULL), headerLength(0), myMacAddr(LAddress::L2NULL), coreDebug(false), phyHeaderLength(
                        0)
        {
        }
        BaseMacLayer(unsigned stacksize) :
                BaseLayer(stacksize), phy(NULL), headerLength(0), myMacAddr(LAddress::L2NULL), coreDebug(false), phyHeaderLength(
                        0)
        {
        }
         ...
         */
        const LAddress::L2Type& getMACAddress() const
        {
            return myMacAddr;
        }
    ...
    protected:
         ...
         */
        ConstMapping* createSingleFrequencyMapping(simtime_t_cref start, simtime_t_cref end,
                Argument::mapped_type_cref centerFreq, Argument::mapped_type_cref bandWith,
